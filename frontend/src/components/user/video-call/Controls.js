...
const btnStyle =
  "bg-azure p-3 h-[4rem] w-[4rem] rounded-full flex justify-center items-center text-white text-center text-3xl hover:bg-azure-300 transition-all duration-150";
