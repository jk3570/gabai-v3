                                ...
                                <div className="relative flex flex-col gap-5 p-3 overflow-y-scroll border-r border-gray-400 border-opacity-20">
                                    {loading ? (
                                        ...
                                        requestData.map((request) => (
                                            <div key={request._id} className="relative w-full h-auto flex flex-col bg-gray-300 bg-opacity-30 text-sm text-content font-normal shadow-md rounded-md p-3 border border-gray-400 border-opacity-20">
                                                <div className="flex flex-col gap-2"> 
                                                    ...
                                                    <div className="flex flex-row gap-2 w-full">
                                                        <div className="w-[65%]">
                                                            ...
                                                            <div className="flex w-full text-sm font-medium bg-bkg bg-opacity-[80%] border border-azure-200 rounded-md px-2 py-1">{request.date}</div>
                                                        </div>
                                                        <div className="w-[35%]">
                                                            <label className="text-xs text-opacity-[80%]">Time:</label>
                                                            <div className="flex w-full text-sm font-medium bg-bkg bg-opacity-[80%] border border-azure-200 rounded-md px-2 py-1">{request.time}</div>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <label className="text-xs text-opacity-[80%]">Lawyer Name:</label>
                                                        <div className="flex w-full text-sm font-medium bg-bkg bg-opacity-[80%] border border-azure-200 rounded-md px-2 py-1">{request.lawyername}</div>
                                                    </div>
                                                    <div className="flex w-full justify-end mt-2">
                                                        <div className="w-[50%] justify-end">
                                                            <button className={button}>
                                                                <Link to={`/user/video-conference/${request.meetingId}`}>Meet Lawyer</Link>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
