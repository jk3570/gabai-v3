           ...
           {/*  Bottom Part */}
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    <a target="_blank" href="facebook.com" class="text-gray-500 hover:text-azure dark:hover:text-white">
                    ...
                    <a target="_blank" href="discord.com"class="text-gray-500 hover:text-azure dark:hover:text-white ms-5">
                    ...
                    <a target="_blank" href="twitter.com" class="text-gray-500 hover:text-azure dark:hover:text-white ms-5">
                    ...
                    <a target="_blank" href="github.com" class="text-gray-500 hover:text-azure dark:hover:text-white ms-5">
