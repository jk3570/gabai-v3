...
const Signup = ({ initialAddress }) => {
  ...
  const button =
    "flex h-10 px-3 py-2 bg-azure text-white rounded-md justify-center items-center w-[50%] text-sm";
                  ...
                  <div className="w-full h-full flex flex-col-1 justify-center px-4">
                    <div className="w-full h-full grid grid-cols-1 gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        {errors.gender && (
                          <span className={warning}>Gender is required</span>
                        )}
                      </div>
                    ...
                    <div className="w-full h-full grid grid-cols-1 gap-4">
                      ...
                      <div>
                        <div className="flex flex-col">
                          ...
                          {errors.region && (
                            <span className={warning}>Region is required</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="flex flex-col">
                          ...
                          {errors.city && (
                            <span className={warning}>City is required</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="justify-between flex gap-2">
                        <a href="#" className={button} onClick={prevStep}>
                          {" "}
                          {"<"} Previous
                        </a>
                    ...
                    <div className="w-full h-full grid grid-cols-1 gap-4">
                      ...
                      <div>
                        ...
                        {errors.email && errors.email.type === "pattern" && (
                          <span className={warning}>Invalid email address</span>
                        )}
                      </div>
