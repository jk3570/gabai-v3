              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p>Register now for a richer, more empowered journey!</p>
                    ...
                    <div className="flex flex-col py-3">
                      ...
                      <a href="#" className="px-2 py-2 text-md text-center text-black" onClick={prevStep}> {"<"} Previous</a>
                      <br/>
                      <button type="submit" onClick={!error || !errors ? notify : undefined} className="w-24 bg-azure-500 text-white rounded-xl p-2 " disabled={error || error || isLoading || passwordMatchError}>
                        Sign Up!
                      </button>
                      </div>
                      </div>
