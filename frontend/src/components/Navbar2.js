...
return (
  <>
    <nav className="fixed top-0 z-50 bg-white h-[3.875rem] w-full p-[1rem] font-bold border-b-2 border-azure-500">
      <div className="w-full flex justify-between items-center">
        {/* Brand Logo */}
        <button class="group relative z-10 font-bold flex justify-center gap-2 items-center">
